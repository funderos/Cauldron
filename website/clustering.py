...
from .cluster_service import get_clustering, get_elbow, get_stat_fields, get_statistics
...
@login_required
def _clustering():
    return render_template("clustering.html", user=current_user, ids = get_ego_ids(), statfields = get_stat_fields('stat'))
